        ...
        <div class="col-lg-12 col-sm-12 col-xm-12 " >
            <div class="row flex-column-reverse flex-lg-row  sombra">
                ...
                <div class="col-lg-6 p-0" style="height:400px;">
                    <img style="width: 100%;height: 100% ;object-fit: slice" src="recursos/imagenes/busqueda_real.jpg" alt=""/>
                </div>
            </div>                                                                            
        </div>                
    </div> 
    ...
    <div class="row mt-5 justify-content-center">
        <div class="col-lg-12 col-sm-12 col-xm-12 " >
            <div class="row flex-column-reverse flex-lg-row  sombra">
                ...
                <div class="col-lg-6 p-0" style="height:400px;">
                    <img style="width: 100%;height: 100% ;object-fit: slice" src="recursos/imagenes/mapa.jpg" alt=""/>
                </div>
            </div>                                                                            
        </div>                
    </div> 
