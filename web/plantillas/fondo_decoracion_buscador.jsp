<svg style="position: absolute; width: 200px; height: 200px; left: 0px; top: 50px; opacity: 0.3" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path fill="#9A5BCE" d="M68.2,-19.7C74.7,-2.2,56.8,25.7,33.1,42C9.5,58.4,-19.9,63.2,-37.8,50.5C-55.7,37.9,-62.1,7.8,-53.8,-12.1C-45.6,-32,-22.8,-41.7,4,-43C30.8,-44.3,61.7,-37.2,68.2,-19.7Z" transform="translate(100 100)" />
                 ...
                 <svg style="position: absolute; width: 300px; height: 300px; top:50px; right: 0px;opacity: 0.3 " viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg style="position: absolute; width: 100px; height: 100px; top:325px;  right: 50px ;opacity: 0.3 " viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg style="position: absolute; width: 200px; height: 200px;top: 100px; left: 140px;z-index: 1;opacity: 0.3 " viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg style="position: absolute; width: 100px; height: 100px;top: 220px; left: 80px;opacity: 0.3 " viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
